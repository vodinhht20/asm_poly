                                                            ...
                                                            <tr>
                                                                <td valign="top" align="left" rowspan="1" colspan="1">
                                                                    ...
                                                                    <p
                                                                       ...
                                                                       Chúng tôi vừa nhận thấy thông tin dự án của sinh viên đã được phê duyệt từ giáo viên bộ môn,
                                                                        bạn vui lòng kiểm tra xác nhận phê duyệt nếu đủ yêu cầu 
                                                                    </p>
                                                                    <hr>
                                                                    <b>Thông tin dự án:</b>
                                                                    <p>Tên dự án: <b>{{$productName}}</b></p>
                                                                    <p>Giáo viên đã phê duyệt: <b>{{$teacherApprove}}</b></p>
                                                                    <p>Tên môn: <b>{{$codeSubject}} - {{$codeName}}</b></p>

                                                                    <div style="margin-top:24px; display: flex; justify-content: center;">
                                                                        <a href="{{route('final-preview')}}"
