                                                            ...
                                                            <tr>
                                                                <td valign="top" align="left" rowspan="1" colspan="1">
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Chúng tôi vừa nhận được thông báo đăng ký lưu trữ dự án của sinh viên. Thầy/cô vui lòng xem lại dự án của sinh viên
                                                                        mình có trùng khớp với thông tin trước đó hay không. Xác nhận nếu đủ điều kiện đăng sản phẩm và từ chối nếu không đủ điều kiện.
                                                                    </p>
                                                                    <hr>
                                                                    <b>Thông tin dự án:</b>
                                                                    <p>Tên dự án: <b>{{$nameProducts}}</b></p>
                                                                    <p>Người tạo: <b>{{$createBy}}</b></p>
                                                                    <p>Thể Loại: <b>{{$productType}}</b></p>
                                                                    <p>Môn học: <b>{{$subjectName}}</b></p>
