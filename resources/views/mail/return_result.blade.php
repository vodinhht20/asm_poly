                                            ...
                                            <td align="center">
                                                <div style="max-width:470px;margin:0 auto">
                                                    <h1
                                                        ...
                                                        Trả kết quả các sinh viên đủ điều kiện lưu trữ dự án
                                                    </h1>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td valign="top" align="left" rowspan="1" colspan="1">
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Sau khi phân tích và chạy trên hệ thống. Đã quét và gửi thông tin sinh viên. Kết quả:
                                                                    </p>
                                                                    <hr>
                                                                    <p>Số sinh viên đã chạy: <b>{{$countResult}}</b></p>
                                                                    <p>Thời gian bắt đầu chạy: <b>{{$start_time}}</b></p>
                                                                    <p>Thời gian kết thúc: <b>{{$end_time}}</b></p>
